...
define("pub", ["jquery.extend","easyui.extend","my97","param","bootstrap","layer.min"], function(){});
...
require.config({
    ...
    shim:{
        ...
        "pub":['jquery.extend','easyui','my97','param','layer.min'],
        "edit":['pub'],
